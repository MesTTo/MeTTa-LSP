...
export const CAPABILITIES = [
  ...
  {
    id: "lsp_simplify",
    title: "proof-replayed equality-saturation simplification",
    category: "advanced",
    lspMethods: ["metta/simplify", "workspace/executeCommand:metta.lsp.simplify"],
    mcpTools: ["lsp_simplify"],
    cliCommands: ["simplify"],
    surfaces: ["lsp", "mcp", "cli", "vscode", "agent"],
    needsRuntime: true,
    guardedRuntime: false,
    readOnly: false,
  ...
  {
    id: "lsp_deduplicate",
    title: "alpha-equivalent semantic clone detection",
    category: "advanced",
    lspMethods: ["metta/deduplicate"],
    mcpTools: ["lsp_deduplicate"],
    cliCommands: ["deduplicate"],
    surfaces: ["lsp", "mcp", "cli", "vscode", "agent"],
    needsRuntime: false,
    guardedRuntime: false,
    readOnly: true,
